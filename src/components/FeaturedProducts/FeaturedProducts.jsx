...
function FeaturedProducts({type}) {
  ...
  return (
    <div className='featuredproducts'>
        <div className="top">
            <h1>{type} Products</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus, quis labore. Possimus corrupti voluptatem cum eligendi praesentium a suscipit vero eum nulla similique, nemo magni minima ipsam earum delectus nobis, itaque, fugiat sunt excepturi accusantium porro molestias? Nesciunt, dolorem delectus!.</p>
        </div>
